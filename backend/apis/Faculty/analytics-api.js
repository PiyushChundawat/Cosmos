// routes/analytics/testAnalytics.js
...
router.get("/test-summary/:testId", async (req, res) => {
    try {
...
router.get("/question-stats/:testId", async (req, res) => {
    try {
        const { testId } = req.params;
...
router.get("/all-tests-summary", async (req, res) => {
    try {
        const facultyId = req.user.id;
...
router.get("/student-performance/:testId", async (req, res) => {
    try {
        const { testId } = req.params;
        const facultyId = req.user.id;
