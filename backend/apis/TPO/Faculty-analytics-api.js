...
// Faculty Analytics - Performance bands by faculty/subject
router.get("/faculty-analytics/performance-bands", async (req, res) => {
    try {
...
// Faculty Analytics - Complete analytics with average scores
router.get("/faculty-analytics/complete", async (req, res) => {
    try {
        const { subject } = req.query;
