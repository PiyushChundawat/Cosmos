...
export default function ResumeUpload() {
  ...
  const studentId = localStorage.getItem('studentId'); // ⚠️ SET THIS after student login!
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-xl p-12">
          ...
          <div className="mb-8">
            <label
              ...
              className="block w-full p-12 border-2 border-dashed border-gray-300 rounded-xl cursor-pointer hover:border-emerald-400 bg-white transition-colors"
            >
            ...
            <div className="mt-6 p-4 bg-emerald-50 border border-emerald-200 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-700">This may take 10-30 seconds</p>
                </div>
              </div>
            </div>
          )}
