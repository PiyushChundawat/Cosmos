  ...
  const handleEditProfile = async (formData) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Refetch the complete profile data after successful update
        await fetchProfile();
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      {error && (
        <div className="fixed top-20 left-1/2 transform -translate-x-1/2 z-50 max-w-md">
          <div className="bg-red-500 text-white px-6 py-3 rounded-lg shadow-lg flex items-center justify-between gap-4">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white border-2 border-indigo-200 rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 p-6 text-center sticky top-6">
              ...
              <button 
                ...
                className="w-full mt-6 bg-indigo-600 text-white py-3 rounded-xl font-semibold hover:bg-indigo-700 transition shadow-md disabled:opacity-50"
                disabled={isSaving}
              >
