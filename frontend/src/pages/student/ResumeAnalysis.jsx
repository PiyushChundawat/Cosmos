        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 text-center mb-6">
          ...
          {analysisData.analyzedAt && (
            <p className="text-sm text-gray-500 mt-4">
              Analyzed on{' '}
              {new Date(analysisData.analyzedAt).toLocaleDateString('en-IN', {
                year: 'numeric',
                month: 'long',
                day: 'numeric',
              })}
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                  ...
                  <ul className="space-y-3">
                    {analysisData.strengths.map((item, index) => (
                      <li
                        key={index}
                        className="p-4 bg-emerald-50 rounded-xl flex items-start gap-3"
                      >
                        <span>{item}</span>
                      </li>
                    ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {analysisData.fileUrl && (
              <a
                ...
                className="px-6 py-3 bg-slate-600 text-white rounded-xl hover:bg-slate-700 transition font-medium text-center"
              >
