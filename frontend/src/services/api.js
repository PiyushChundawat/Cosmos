...
export const studentAnalyticsAPI = {
  getPerformanceBands: (params = {}) => {
    return api.get('/tpo/student-analytics/performance-bands', {
      params,
    });
  },
  getTopPerformers: (params = {}) => {
    return api.get('/tpo/student-analytics/top-performers', {
      params,
    });
  },
};
...
export const facultyAnalyticsAPI = {
  getPerformanceBands: (subject) => {
    return api.get('/tpo/faculty-analytics/performance-bands', {
      params: { subject },
    });
  },
  getComplete: (subject) => {
    return api.get('/tpo/faculty-analytics/complete', {
      params: { subject },
    });
  },
};
